...
var btnDecrease = document.querySelector('#decrease'); // 액션 이름 생성  ( 대문자로작성한다 / 고유해야함 )

var TOGGLE_SWITCH = 'TOGGLE_SWITCH';
var INCREASE = 'INCREASE';
var DECREASE = 'DECREASE'; // 액션 함수 생성 ( 함수명은 되도록 액션이름을 따르고, 파라미터에 type 으로 생성된 액션이름을 넘긴다. )
...
function reducer() {
  var state = arguments.length > 0 && arguments[0] !== undefined ? arguments[0] : initioalState;
...
var store = (0, _redux.createStore)(reducer); // render Page
...
render(); // store 의 state가 변경될때마다 호출되는 리스너를 추가한다. ( 구독하기 / subscribe )
...
},{"redux":"node_modules/redux/es/redux.js"}],"C:/Users/zkand/AppData/Roaming/npm/node_modules/parcel-bundler/src/builtins/hmr-runtime.js":[function(require,module,exports) {
var global = arguments[3];
...
},{}]},{},["C:/Users/zkand/AppData/Roaming/npm/node_modules/parcel-bundler/src/builtins/hmr-runtime.js","index.js"], null)
//# sourceMappingURL=/reactstudy.e31bb0bc.js.map